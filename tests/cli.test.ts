...
describe("CLI command surface", () => {
  ...
  it("prints laraboxs help with service and tool commands", () => {
    ...
    expect(result.stdout).toContain("laraboxs install [--force] mysql <9.7|8.4|8.0|mariadb-11.8.6>");
    expect(result.stdout).toContain("laraboxs site:entry <site> <entry>");
    expect(result.stdout).toContain("laraboxs uninstall nginx|redis|node|composer");
    ...
    expect(result.stdout).toContain("laraboxs mysql:use <9.7|8.4|8.0|mariadb-11.8.6>");
